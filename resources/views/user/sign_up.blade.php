        ...
        <div class="content"  ng-app="user">
            ...
            <div ng-controller="sign_up">
                <form>
                    ...
                    <div class="gt_slider"><div class="gt_guide_tip gt_show">按住左边滑块，拖动完成上方拼图</div><div class="gt_slider_knob gt_show" style="transform: translate(0px, 0px); -webkit-transform: translate(0px, 0px);"></div><div class="gt_curtain_tip gt_hide">点击上图按钮并沿道路拖动到终点处</div><div class="gt_curtain_knob gt_hide">移动到此开始验证</div><div class="gt_ajax_tip ready"></div></div>
